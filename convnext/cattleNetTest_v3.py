...
class CattleNetV3(nn.Module):
    def __init__(self,freezeLayers=False) -> None:
        super(CattleNetV3,self).__init__()
        ...
        self.classifier = nn.Sequential( # difference layer
            nn.Linear(4096,1),
            nn.Sigmoid()
        )
    ...
    def forward(self,input1,input2):
        ...
        res = self.classifier(torch.abs(torch.sub(out1,out2)))
        return res
